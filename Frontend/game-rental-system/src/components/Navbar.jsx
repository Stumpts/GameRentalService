  ...
  return (
    <>
      <nav className="grid grid-cols-3 border border-neutral-700 rounded-sm p-4 items-center">
        <a className="p-1 rounded-md relative w-30 h-ful lg:w-50 lg:h-full md:w-50 md:h-full duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] active:translate-y-1 active:scale-x-110 active:scale-y-90 hover:-translate-y-1 hover:scale-105 hover:bg-gray-100" href="/">
